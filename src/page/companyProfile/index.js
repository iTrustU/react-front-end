...
class CompanyProfile extends Component {
    ...
    render() {
        ...
        return ( <
            ...
            align = 'center' >
            <
            FontContainer margin = '0'
            size = { 20 } > { companyData.name } < /FontContainer> <
            a target = "_blank"
            href = { companyData.website } >
            <
            Button icon color = 'orange' > { `Website` } <
            /Button> <
            /a> <
            /ProfileContainer> <
            /GeneralContainer> <
            ...
            GeneralContainer padding = '2vh 2vw' >
            <
            AgentListH conmpanyId = { companyData.id }
            /> <
            /GeneralContainer> <
            /MainContainer> <
            /Container> <
